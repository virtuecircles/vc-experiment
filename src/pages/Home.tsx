...
const Home = () => {
  ...
  const plans = [
    ...
    },
    {
      ...
      price: "$100/month",
      features: [
        "2 Virtue-guided meetups/month",
        "Customized virtue-based matching",
    ...
    <div className="min-h-screen relative">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center space-y-6 mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Where Aristotle's timeless wisdom meets modern AI to connect you with people who share your values and
              virtues.
            </p>
      ...
      <section className="py-20 px-4 bg-muted/30">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground">Science-backed matching based on character strengths</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <GlowCard className="p-8">
              ...
              <p className="text-muted-foreground">
                Answer questions based on the VIA Institute's 24 character strengths, rooted in Aristotelian virtue
                ethics.
              </p>
            </GlowCard>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-display font-bold mb-6">From Ancient Wisdom to Modern Science</h2>
              <p className="text-lg text-muted-foreground mb-6">
                2,400 years ago, Aristotle identified that true friendship is based on shared virtue and character.
                Today, the VIA Institute has scientifically validated 24 character strengths that form the foundation of
                human excellence.
              </p>
              <p className="text-lg text-muted-foreground mb-6">
                Virtue Circles combines this ancient wisdom with cutting-edge AI to help you find friends who truly
                understand and complement your character.
              </p>
              <Link to="/aristotle">
            ...
            <GlowCard className="p-8">
              <div className="space-y-4">
                <h3 className="text-2xl font-display font-bold gradient-text">The 6 Virtue Clusters</h3>
                {virtues.map((virtue) => (
      ...
      <section className="py-20 px-4 bg-muted/30">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {plans.map((plan) => (
              <GlowCard key={plan.name} className={`p-8 ${plan.popular ? "ring-2 ring-primary" : ""}`}>
                {plan.popular && (
